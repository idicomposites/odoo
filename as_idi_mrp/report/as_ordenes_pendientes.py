...
class as_kardex_productos_excel(models.AbstractModel):
    ...
    def generate_xlsx_report(self, workbook, data, lines):   
            ...
            sheet.write(7, 0,'CANT (KG)',titulo2)
            sheet.write(7, 1,'CLIENTE ',titulo2)
            sheet.write(7, 2,'SO',titulo2)
            sheet.write(7, 3,'FECHA DESEADA',titulo2)
            sheet.write(7, 4,'FECHA DE CONFIRMACIÓN',titulo2l)
            sheet.write(7, 5,'CONFIRMACION DE PRODUCCIÓN',titulo2)
            sheet.write(7, 6,'CONFIRMACÓN DE CLIENTE',titulo2l)
            sheet.write(7, 7,'FECHA DE ENTREGA',titulo2)
            sheet.write(7, 8,'MOTIVO',titulo2l)
            sheet.write(7, 9,'DOCUMENTOS',titulo2l)
            filas = 8
            ...
            for line in all_movimientos_almacen:
                ...
                sheet.write(filas,0, line[1],formato)
                sheet.write(filas,1, line[2] or '',formato)
                sheet.write(filas,2, line[3] or '',formato)
                sheet.write(filas,3, self.get_format_date(picking.scheduled_date) or '',formato)
                sheet.write(filas,4, '',formatol)
                sheet.write(filas,5, self.get_format_date(mrp.date_planned_start) or '',formato)
                sheet.write(filas,6, '',formatol)
                sheet.write(filas,7, self.get_format_date(picking.date_done),formato)
                sheet.write(filas,8, '',formatol)
                sheet.write(filas,9, '',formatol)
                filas += 1
